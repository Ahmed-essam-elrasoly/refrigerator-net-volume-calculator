...
|  |  |  |  | OK! |  | R-600a=1,R-134a=2 | 1 | `=IF(H3=1,"R-600a",IF(H3=2,"R-134a","??"))` |  |  |  | 冷媒 | R-600a |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| ◇  ＴＥＭＰＡＲＡＴＵＲＥ  ◇ | (℃) |  | ◇HEAT LOAD ◇ |  |  | ◇  Compressor Data  ◇ |  |  |  |  |  | COMP NAME | EGX80CLC 100V 50Hz |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| F ROOM   TF      (℃) | -18 |  | QF     TOTAL(kcal/h)  (inlet) | `=SIZE!E32` |  | COMPRESSOR NAME | `=N4` | R-600a |  |  |  | Capacity | 181.6 |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| R ROOM   TR      (℃) | 3 |  | QR     TOTAL(kcal/h)  (inlet) | `=SIZE!E33+E8` |  | 220/240V 50Hz |  |  |  |  |  | COP | 1.77 |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| DP CON.  TC      (℃) | `=B8+E39` |  | QEV    TOTAL (kcal/h)  (inlet) | `=SIZE!E34` |  | 定格ｺｰﾅｰ |  |  |  |  |  | Rpm0= | 2900 |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| OUTSIDE  T0      (℃) | 30 |  | heater          (kcal/h) | 0 |  | N(rpm) | 2900 |  | Volume Efficiency |  |  | Vc= | 11.14 | 回転速度補正 |  |  |  |  |  |  |  |  |  |  |  |  |  |
|  |  |  | heater          (W) | `=E8/0.86` |  | Vc(cc) | `=N8` |  | ηv=(A+B*PC/PE+C*PC)*Kηv |  |  | A= | 0.9260142251566365 | a= | 1 |  |  |  |  |  |  |  |  |  |  |  |  |
| ◇  Ｏ Ｔ Ｈ Ｅ Ｒ Ｓ  ◇ |  |  | Qtotal  (=QF+QR+QEV) | `=SUM(E5:E7)` |  | ηv | `=(N9+N10*H14/H15+N11*H14)*K10` |  | Kηv= | `=P9+P10*H8+P11*H8^2` |  | B= | -0.01221312333322575 | b= | 0 |  |  |  |  |  |  |  |  |  |  |  |  |
| FAN TOTAL                (m3/h) | `=70*B13/3000*(B12/100)^2` |  |  |  |  | T IN | 32.2 |  |  |  |  | C= | -0.0023789273042382304 | c= | 0 |  |  |  |  |  |  |  |  |  |  |  |  |
| FAN Diameter   φmm | 100 |  | ◇  CALCULATION ◇ |  |  | TC  Cond | 54.4 |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| FAN SPEED               (rpm) | 2550 |  | Fan out air temp         T3      (℃) | `=E37+E7/B11/B21/B20/E38` |  | TE  Evap | -23.3 |  | R-600a | R-134a |  | AW= | 135.175 | 回転速度補正 |  |  |  |  |  |  |  |  |  |  |  |  |  |
...
| TIMER   Period          (hr) | 10.5 |  | QEV'    =M*γ*CP*(TEVIN-TEVOUT)*PR | `=B11*B21*B20*(E13-E37)*E38` |  | V(比体積） | `=IF(H3=1,J18,IF(H3=2,K18,"??"))` |  | `= 0.015883+0.001455*(H11+273.16)/J15-7.2936/(H11+273.16)-0.0004645*J15` | `=0.01248+0.0008207*(H11+273.16)/K15-4.663/(H11+273.16)-0.0002297*K15` |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| Def. HEATER   ON  time  (min) | 0 |  | Air Speed in Evaporator       (m/sec) | `=B11/(B24*B25)/3600*10^6` |  | G(循環流量) | `=H10*H8*60*H9*10^(-6)/H18` |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
...
| EV WIDTH  (=30mm*N)      (mm) | 460 |  | EV TEMPRATURE                  (℃) | `=(E20-E22*E37)/(1-E22)` |  | COP | `=H21/H23/0.86` | W=(AW+BW*TE+CW*TC*TE+DW*TE^2)*Kw*Rpm/Rpm0 |  |  |  |  | T0= | `=B8` |  |  |  |  |  |  |  |  |  |  |  |  |  |
| EV DEPTH                 (mm) | 60 |  | QEV''(Ability of Evaporator)  (kcal/h) | `=E23*B33*E21` |  |  |  |  |  |  |  |  | Tsub= | `=K28` |  |  |  |  |  |  |  |  |  |  |  |  |  |
| EV Tire (段数) | 7 |  | COMP INPUT | `=K32` |  | ◇  Cooling capacity of Refrigerator Condition  ◇ |  |  |  |  |  |  | R-600a | R-134a |  |  |  |  |  |  |  |  |  |  |  |  |  |
...
| 7 段 | 24 |  | F1= QF-QF' | `=E5-E16` |  | Q COND  Qcin | `=H31*(H45-H46)` | kcal/kg | Discharge |  |  |  | TC= | `=B7` |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 8 段 |  |  | F2= Qtotal-Qcomp*PR | `=E10-E30*E38` |  | enthalpy |  |  | Temp | 60 |  |  | Td= | `=K44` |  |  |  |  |  |  |  |  |  |  |  |  |  |
