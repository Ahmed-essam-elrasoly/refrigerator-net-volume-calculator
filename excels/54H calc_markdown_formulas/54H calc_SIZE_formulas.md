...
| F LEFT | 59.4 |  | R BACK | `=H18*(J18-I18)` | `=(B8-(B20+B27)/2-B11)*(B9-(B24+B25)/2)*10^(-6)` | `=1/(1/B$40+1/B$41+B26/1000/(B$34+0.00011*(I18+J18)/2))` | `=G18*F18` | `=H2` | `=(F3-H4)*F1+H4` |
| F RIGHT | 59.4 |  | R BOTTOM　1 | `=H19*(J19-I19)` | `=(B9-(B24+B25)/2)*B12*10^(-6)` | `=1/(1/B$40+1/B$41+B27/1000/(B$34+0.00011*(I19+J19)/2))` | `=G19*F19` | `=H2` | `=J18` |
| F BOTTOM ※ | 70 |  | R BOTTOM　2 | `=H20*(J20-I20)` | `=(B9-(B24+B25)/2)*(SQRT(B11^2+(B13-B12)^2))*10^(-6)` | `=1/(1/B$40+1/B$41+B28/1000/(B$34+0.00011*(I20+J20)/2))` | `=G20*F20` | `=H2` | `=J18` |
