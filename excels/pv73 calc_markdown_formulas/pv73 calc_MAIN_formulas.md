...
| TIMER   Period          (hr) | 10.5 |  | QEV'    =M*γ*CP*(TEVIN-TEVOUT)*PR | `=B11*B21*B20*(E13-E37)*E38` |  | V(specific volume） | `=IF(H3=1,J18,IF(H3=2,K18,"??"))` |  | `= 0.015883+0.001455*(H11+273.16)/J15-7.2936/(H11+273.16)-0.0004645*J15` | `=0.01248+0.0008207*(H11+273.16)/K15-4.663/(H11+273.16)-0.0002297*K15` |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
