...
// Compressor – identical except we'll use the same parameters but note the subcool
const compParams = {
  ...SJ54H_COMPONENTS.compressor,
  // The coefficients you listed are the same as SJ54H, so no change needed
};
...
const config = {
  ...
  condenserConfig,
  refrigerant: 'R-600a',
  subcool: 10,                     // ← THE CRITICAL CHANGE
  dischargeTemp: 60,
...
console.log('=== SJ-540 SOLVER (subcool=10°C) ===');
