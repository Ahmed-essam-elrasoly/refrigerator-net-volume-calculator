// tests/debug_final_v6.mjs – lambda = 0.0165 + 0.00011*(T_avg - 25)
...
// ── CORRECTED lambda (urethane at 25°C = 0.0165, slope = 0.00011 per °C) ──
function lambdaUrethane(T_inside, T_outside) {
  const T_avg = (T_inside + T_outside) / 2;
  return 0.0165 + 0.00011 * (T_avg - 25);   // Excel B34 + 0.00011*(T_avg - 25)
}
...
console.log('=== SJ-540 SOLVER (corrected lambda) ===');
